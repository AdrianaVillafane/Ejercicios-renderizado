...
<h2> Esto es un repaso de renderizado</h2>`*/
...
/*const verTabla =(multiplicador) => {
    for (let i =1; i <= 100; i++) {
        ...
        <p class= "text">${multiplicador}x ${i}es igual a ${i * multiplicador}
        </p>
        </div>`;
    }
}*/
...
let user = {
  fullname: "Adriana Villafañe",
  email: "tsade@live.com.ar",
  age: 51,
}
...
const datos1 = { id: 0, nombre: "Ada Lovelace", email: "ada@gmail.com", telefono: "1234567890", };
console.log(datos1);
const datos2 = { id: 1, nombre: " Grace Hopper", email: "grace@gmail.com", telefono: "1230456789", };
console.log(datos2);
const datos3 = { id: 2, nombre: "Hedy Lamar", email: "hedy@gmail.com", telefono: "1234560789", };
console.log(datos3);
const datos4 = { id: 3, nombre: "Radia Perlman", email: "radia@gmail.com", telefono: "7418520963", };
console.log(datos4);
const datos5 = { id: 4, nombre: "Sheryl Sandberg", email: "sheryl@gmail.com", telefono: "7089456123", };
console.log(datos5);

console.log(datos1.nombre);
console.log(datos2.id);
console.log(datos3.email);
console.log(datos4.id, datos4.nombre);
console.log(datos5.telefono);
...
/*var datos = {
  ...
  edad: 29,
  programa: true,
  programasFav: function (){
    if (this.programa === true);
    return datos.push ("lenguajeFavorito");
  }
};
this.programasFav = "Javascript";
// codea aca la solucion
...
console.log(`Hola mi nombre es: ${datos.nombre} y programo en  ${datos.lenguajeFav}.`);
